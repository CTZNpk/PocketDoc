      ...
      footer={
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            <button
              type="button"
              className="flex-1 py-2 px-4 bg-gray-800 hover:bg-gray-700 text-white rounded-lg border border-gray-700 transition duration-200 flex items-center justify-center"
            >
